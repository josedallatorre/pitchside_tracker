...
class BallPassClient(Node):
    def __init__(self):
        ...
        ball_pos = ball_config["position"]
        kick_positions.insert(0,ball_pos) # insert ball position in first position
        ...
        self.pass_positions = build_pass_positions(kick_positions)
    ...
    def pass_ball(self, positions=None, speed=0.5, tolerance=0.5):
        ...
        for i in range(len(positions) - 1):
            ...
            # Logging the cause of the pass failure
